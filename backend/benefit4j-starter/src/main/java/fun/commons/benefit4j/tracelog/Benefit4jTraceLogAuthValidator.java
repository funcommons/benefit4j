package fun.commons.benefit4j.tracelog;
...
/**
 * benefit4j 的 TraceLog 控制台鉴权实现：仅平台运营凭据签发的 token 可查询/开关/导出。
 * <p>
 ...
 */
@Slf4j
public class Benefit4jTraceLogAuthValidator implements TraceLogAuthValidator {

    private final ObjectProvider<AccessTokenProperties> accessTokenPropertiesProvider;

    public Benefit4jTraceLogAuthValidator(ObjectProvider<AccessTokenProperties> accessTokenPropertiesProvider) {
