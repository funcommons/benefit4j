...
public interface BenefitPlatformClient {
    ...
    // 修改全局通用权益模板
    Object putGlobalTemplatesTmplId(@org.springframework.web.bind.annotation.PathVariable("tmpl_id") Long tmplId, @org.springframework.web.bind.annotation.RequestBody fun.commons.benefit4j.dto.PutGlobalTemplatesTmplIdRequest req);
    ...
    // 平台级权益项模板 CRUD
    Object postItemTemplates(@org.springframework.web.bind.annotation.RequestBody fun.commons.benefit4j.dto.PostItemTemplatesRequest req);

    Object getItemTemplates();

    Object putItemTemplatesItemId(@org.springframework.web.bind.annotation.PathVariable("item_id") Long itemId, @org.springframework.web.bind.annotation.RequestBody fun.commons.benefit4j.dto.PutItemTemplatesItemIdRequest req);
