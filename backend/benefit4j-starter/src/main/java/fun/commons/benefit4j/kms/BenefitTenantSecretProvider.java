 ...
 * 本 provider 解码为雪花 id 查 ubma_tenant, 返回 tenant_secret 明文
...
public class BenefitTenantSecretProvider implements SecretProvider {

    private static final Logger log = LoggerFactory.getLogger(BenefitTenantSecretProvider.class);
    ...
    public String getSecret(String accessKey) {
        ...
        try {
            ...
            if (app == null) {
                log.warn("[Signature] accessKey={} 解码 tenantId={} 无对应 application", accessKey, tenantId);
                return null;
            }
