...
public class BenefitPlatformController {
    ...
    public Object postGlobalTemplates(
            @Valid @RequestBody fun.commons.benefit4j.dto.PostGlobalTemplatesRequest req) {
    ...
    public Object putGlobalTemplatesTmplId(
            ...
            @Valid @RequestBody fun.commons.benefit4j.dto.PutGlobalTemplatesTmplIdRequest req) {
    ...
    public Object postItemTemplates(
            @Valid @RequestBody fun.commons.benefit4j.dto.PostItemTemplatesRequest req) {
    ...
    public Object putItemTemplatesItemId(
            ...
            @Valid @RequestBody fun.commons.benefit4j.dto.PutItemTemplatesItemIdRequest req) {
