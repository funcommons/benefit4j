...
public interface BenefitPlatformService {
    ...
    // 修改全局通用权益模板
    Object putGlobalTemplatesTmplId(Long tmplId, fun.commons.benefit4j.dto.PutGlobalTemplatesTmplIdRequest req);
    ...
    // 平台级权益项模板 CRUD
    Object postItemTemplates(fun.commons.benefit4j.dto.PostItemTemplatesRequest req);

    Object getItemTemplates();

    Object putItemTemplatesItemId(Long itemId, fun.commons.benefit4j.dto.PutItemTemplatesItemIdRequest req);
