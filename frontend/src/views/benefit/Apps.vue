<template>
  <div class="app-page apps-page">
    <FcSectionHeader :title="t('benefit.apps-title')" :subtitle="t('benefit.apps-subtitle')">
      <template #actions>
    ...
    <FcSection>
      <el-scrollbar>
        <el-table
          ...
          :max-height="600"
        >
          <el-table-column :label="t('benefit.app-name')" min-width="200">
    ...
    >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="120px">
        <el-form-item class="fc-form-item" :label="t('benefit.app-name')" prop="name">
...
import { getApps, createApp, updateApp, resetAppSecret, revealAppSecret } from '@/api/benefitApp'
...
defineOptions({ name: 'BenefitApps' })
