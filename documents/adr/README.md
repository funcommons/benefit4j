...
| ADR | 标题 | 状态 |
|---|---|---|
| [0001](0001-framework4j-tokencontext-appid-missing.md) | framework4j TokenContext 不填 tenant_id claim | 已修复 (v1.2.8) |
...
| [0006](0006-app-secret-encryption-lazy-key.md) | tenant_secret AES 加密 + TypeHandler lazy key | 已实施 |
